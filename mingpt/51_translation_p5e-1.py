...
class TrainerConfig:
    ...
    train_dataset = {
        ...
        'h_translation_prob': 0.5,
        'v_translation_prob': 0.5,
        'max_translation': 26.689 / 4,
    }
    val_dataset = {
        'data_path': '../../Fruit_Fly_Groups/Notebooks/data/user_train.npy',
    ...
    # checkpoint settings
    ckpt_dir = f'./experiments/fly/51_translation_p5e-1'
    # CUDA_VISIBLE_DEVICES=0 python 51_translation_p5e-1.py > experiments/fly/log/51_translation_p5e-1.log
