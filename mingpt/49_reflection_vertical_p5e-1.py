...
class TrainerConfig:
    ...
    # checkpoint settings
    ckpt_dir = f'./experiments/fly/49_reflection_vertical_p5e-1'
    # CUDA_VISIBLE_DEVICES=0 python 49_reflection_vertical_p5e-1.py > experiments/fly/log/49_reflection_vertical_p5e-1.log
