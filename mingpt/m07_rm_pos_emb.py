...
from model4 import GPT, GPT1Config
...
class TrainerConfig:
    ...
    # checkpoint settings
    ckpt_dir = f'./experiments/fly/m07_rm_pos_emb'
    # CUDA_VISIBLE_DEVICES=2 python m07_rm_pos_emb.py > experiments/fly/log/m07_rm_pos_emb.log
...
if __name__ == '__main__':
    ...
    train_set = mouse_aug_dataset_2(config.train_dataset)
    val_set = mouse_aug_dataset_2(config.val_dataset)
