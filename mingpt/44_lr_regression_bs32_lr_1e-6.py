...
class TrainerConfig:
    ...
    # checkpoint settings
    ckpt_dir = f'./experiments/fly/44_lr_regression_bs32_lr_1e-6'
    # CUDA_VISIBLE_DEVICES=0 python 44_lr_regression_bs32_lr_1e-6.py > experiments/fly/log/44_lr_regression_bs32_lr_1e-6.log
