...
class TrainerConfig:
    ...
    # checkpoint settings
    ckpt_dir = f'./experiments/fly/45_lr_regression_lr_cosine_reproduce'
    # CUDA_VISIBLE_DEVICES=0 python 45_lr_regression_lr_cosine.py > experiments/fly/log/45_lr_regression_lr_cosine_reproduce.log
