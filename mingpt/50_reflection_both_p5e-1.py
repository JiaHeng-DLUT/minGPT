...
class TrainerConfig:
    ...
    # checkpoint settings
    ckpt_dir = f'./experiments/fly/50_reflection_both_p5e-1'
    # CUDA_VISIBLE_DEVICES=0 python 50_reflection_both_p5e-1.py > experiments/fly/log/50_reflection_both_p5e-1.log
