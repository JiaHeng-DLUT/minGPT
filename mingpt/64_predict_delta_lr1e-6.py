...
class TrainerConfig:
    ...
    # checkpoint settings
    ckpt_dir = f'./experiments/fly/64_predict_delta_lr1e-6'
    # CUDA_VISIBLE_DEVICES=0 python 64_predict_delta_lr1e-6.py > experiments/fly/log/64_predict_delta_lr1e-6.log
