...
class TrainerConfig:
    ...
    # checkpoint settings
    ckpt_dir = f'./experiments/fly/68_tanh_mse_fix_warmup'
    # CUDA_VISIBLE_DEVICES=1 python 68_tanh_mse_fix_warmup.py > experiments/fly/log/68_tanh_mse_fix_warmup.log
