...
class TrainerConfig:
    ...
    # checkpoint settings
    ckpt_dir = f'./experiments/fly/46_regression_ce_lr1e-5'
    # CUDA_VISIBLE_DEVICES=0 python 46_regression_ce_lr1e-5.py > experiments/fly/log/46_regression_ce_lr1e-5.log
