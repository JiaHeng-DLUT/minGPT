...
class TrainerConfig:
    ...
    # checkpoint settings
    ckpt_dir = f'./experiments/fly/05_max_epoch_100_seed_0_2'
    # CUDA_VISIBLE_DEVICES=1 python 05_max_epoch_100_seed_0_2.py > experiments/fly/log/05_max_epoch_100_seed_0_2.log
