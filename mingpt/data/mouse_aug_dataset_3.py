...
class mouse_aug_dataset_3(data.Dataset):
    """Fruit fly dataset.
    """

    def __init__(self, opt):
        super(mouse_aug_dataset_3, self).__init__()
        self.opt = opt
...
if __name__ == '__main__':
    ...
    dataset = mouse_aug_dataset_3(train_dataset)
    ...
    #     'total_frame': 4500,
    # }
    # dataset = mouse_aug_dataset_3(val_dataset)
