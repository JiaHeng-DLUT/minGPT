...
class TrainerConfig:
    ...
    # checkpoint settings
    ckpt_dir = f'./experiments/fly/70_ST_msak_attention_loss_result'
    # CUDA_VISIBLE_DEVICES=0 python 70_ST_msak_attention_loss_result.py > experiments/fly/log/70_ST_msak_attention_loss_result.log
