...
class TrainerConfig:
    ...
    # data
    train_dataset = {
        'data_path': ['../../Fruit_Fly_Groups/Notebooks/data/user_train.npy', '../../Fruit_Fly_Groups/Notebooks/data/submission_data.npy'],
    ...
    # checkpoint settings
    ckpt_dir = f'./experiments/fly/59_tanh_test'
    # CUDA_VISIBLE_DEVICES=0 python 59_tanh_test.py > 59_tanh_test.log
