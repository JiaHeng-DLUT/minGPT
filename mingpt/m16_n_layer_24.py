...
from model6 import GPT, GPT1Config
...
class TrainerConfig:
    ...
    train_dataset = {
        ...
        'meta_path': 'meta_info/mouse_meta_info_train_0_test.txt',
    ...
    # checkpoint settings
    ckpt_dir = f'./experiments/fly/m16_n_layer_24'
    # CUDA_VISIBLE_DEVICES=1 python m16_n_layer_24.py > experiments/fly/log/m16_n_layer_24.log
    ...
    def train(self):
        ...
        def run_epoch(split):
            ...
            for it, data in pbar:
                ...
                if 'labels' in data:
                    y = data['labels'].to(self.device).long()
                else:
                    y = None
...
if __name__ == '__main__':
    ...
    train_set = mouse_aug_dataset_4(config.train_dataset)
    val_set = mouse_aug_dataset_4(config.val_dataset)
