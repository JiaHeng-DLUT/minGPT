...
class TrainerConfig:
    ...
    # checkpoint settings
    ckpt_dir = f'./experiments/fly/73_spatial_temporal_transformer'
    # CUDA_VISIBLE_DEVICES=0 python 73_spatial_temporal_transformer.py > experiments/fly/log/73_spatial_temporal_transformer.log
