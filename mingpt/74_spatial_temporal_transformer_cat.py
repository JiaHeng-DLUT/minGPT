...
class TrainerConfig:
    ...
    # checkpoint settings
    ckpt_dir = f'./experiments/fly/74_spatial_temporal_transformer_cat'
    # CUDA_VISIBLE_DEVICES=3 python 74_spatial_temporal_transformer_cat.py > experiments/fly/log/74_spatial_temporal_transformer_cat.log
