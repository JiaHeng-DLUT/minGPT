...
class TrainerConfig:
    ...
    # checkpoint settings
    ckpt_dir = f'./experiments/fly/48_reflection_horizon_p5e-1'
    # CUDA_VISIBLE_DEVICES=0 python 48_reflection_horizon_p5e-1.py > experiments/fly/log/48_reflection_horizon_p5e-1.log
